...
db.createCollection("oblasts");
oblasts.forEach((oblast) => {
  db.oblasts.insertOne({
    oblast: oblast,
    createdAt: new Date(),
    updatedAt: new Date(),
  });
...
const allBrands = db.brands.find({});
if (allBrands) {
  db.createCollection("models");

  allBrands.forEach((brand) => {
    autoBrands.forEach((autoBrand) => {
      if (brand.brand === autoBrand.brand) {
        autoBrand.models.forEach((model) => {
          db.models.insertOne({
            model: model,
            _brandId: brand._id,
            createdAt: new Date(),
